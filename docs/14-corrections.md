# 14 — corrections: eleven in the pre-briefing, ten of this session's own, and five violations of the rule this session declared unbreakable

*Measure: every correction below names the command that establishes it. The
